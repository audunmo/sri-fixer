...
var (
  input = "test-data"
  hash256 = "oYYABCL+q4VzKcaE6f6RQSsaXbCEEAs3qYz8lbYqqGc"
  hash384 = "vnqLl9XO0CW4TZyma7tvp0uml21xQDQmSDV3NngFxQLt/Njwq8uKuaO6VOHiigwM"
  hash512 = "uFFwBg3iPS4GYj4luRB4uIknI3tsfV7Qd7mJjLh2txcd+lfxPMA1Wso1mTuFAhjPC2nRFncuI81dW5a+MEjp/A"
)
...
func TestMultipleSHA(t *testing.T) {
  ...
  exp_hashes := map[crypto.Hash]string {
    crypto.SHA256: "oYYABCL+q4VzKcaE6f6RQSsaXbCEEAs3qYz8lbYqqGc",
    crypto.SHA384: "vnqLl9XO0CW4TZyma7tvp0uml21xQDQmSDV3NngFxQLt/Njwq8uKuaO6VOHiigwM",
    crypto.SHA512: "uFFwBg3iPS4GYj4luRB4uIknI3tsfV7Qd7mJjLh2txcd+lfxPMA1Wso1mTuFAhjPC2nRFncuI81dW5a+MEjp/A",
  }
